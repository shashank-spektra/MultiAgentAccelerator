...
```
gpt5.4:150,o4-mini:50,gpt5.4-mini:50
```
### 📌 Default Regions:
```
...
✔️ Check specific model(s) in default regions:
  ```
  ./quota_check_params.sh --models gpt5.4:150
  ```
...
✔️ Passing Both models and regions:  
  ```
  ./quota_check_params.sh --models gpt5.4:150 --regions eastus2,westus
  ```
✔️ All parameters combined:
  ```
 ./quota_check_params.sh --models gpt5.4:150 --regions eastus2,westus --verbose
  ```
✔️ Multiple models with single region:
  ```
 ./quota_check_params.sh --models gpt5.4:150,gpt5.4-mini:50 --regions eastus2 --verbose
  ```
